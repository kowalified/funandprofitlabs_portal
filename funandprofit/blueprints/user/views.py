""" route views for user login/logout """
...
from funandprofit.blueprints.user.decorators import anonymous_required
from funandprofit.blueprints.user.models import User
from funandprofit.blueprints.user.forms import (
    LoginForm,
...
def signup():
    ...
    if form.validate_on_submit():
        ...
        message = " 👶 "+ u.first_name + " (Student #" + str(u.student_number) + ") has created a new account with $" +str(u.money) + " to start.\n"
...
@login_required
def settings():
    """ No need for settings page, so just redirect to the portal """
